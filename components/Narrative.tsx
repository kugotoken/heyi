      ...
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 relative items-start">
          ...
          <div className="relative group p-6 md:p-10 border-l-8 border-gray-600 bg-binance-dark hover:bg-gray-900 transition-all duration-500 shadow-xl rounded-r-xl">
            {/* Image Placeholder A - Vertical 962x1280 */}
            <div className="w-full aspect-[962/1280] bg-gray-800 rounded-lg mb-8 overflow-hidden border border-gray-700 relative">
               <img 
                 src="/images/02.jpg" 
          ...
          <div className="relative group p-6 md:p-10 border-l-8 border-binance-yellow bg-binance-dark hover:bg-gray-900 transition-all duration-500 shadow-xl rounded-r-xl mt-0 md:mt-24 md:-ml-8 z-20">
             {/* Image Placeholder B - Horizontal 1080x376 */}
             <div className="w-full aspect-[1080/376] bg-gray-800 rounded-lg mb-8 overflow-hidden border border-binance-yellow/30 relative">
                <img 
                  src="/images/03.jpg" 
